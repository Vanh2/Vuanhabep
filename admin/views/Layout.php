...
<body class="g-sidenav-show  bg-gray-200">
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="#" target="_blank">
                <img src="..../../../assets/frontend/img/logo.jpg" class="navbar-brand-img h-100" alt="main_logo">
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link text-white " href="index.php?controller=categories">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="index.php?controller=products">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white " href="index.php?controller=news">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white " href="index.php?controller=users">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white " href="index.php?controller=orders">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white " href="index.php?controller=login&action=logout">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">login</i>
                        </div>
                        <span class="nav-link-text ms-1" href="">Đăng xuất</span>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <script src="..../../../assets/admin/js/material-dashboard.min.js"></script>
