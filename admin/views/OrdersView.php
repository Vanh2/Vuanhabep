    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td style="text-align:center;">
                        ...
                        <a href="index.php?controller=orders&action=delivery&id=<?php echo $rows->id; ?>"
                            class="label label-info">Giao hàng</a>
                        &nbsp;&nbsp;
                        <?php endif; ?>
                        <a href="index.php?controller=orders&action=detail&id=<?php echo $rows->id; ?>"
                            class="label label-success">Chi tiết</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </table>
            ...
            <ul class="pagination">
                ...
                <li class="page-item"><a href="index.php?controller=orders&p=<?php echo $i; ?>"
